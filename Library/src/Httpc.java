...
public class Httpc {
    ...
    private static ArrayList<String> redirectList = new ArrayList<String>( Arrays.asList("https://www.amazon.com", "https://www.google.com", "https://www.ebay.com") );
    ...
    private static void getRequest(GetSet getSetObj) throws IOException {
        ...
        try {
            ...
            if (response.isEmpty()) {
                ...
                //redirecting
                System.out.println(getSetObj.getPath());
                if (getSetObj.getFileForHttpResponse() != null) {
                    saveResponse(getSetObj.getFileForHttpResponse(), response);
                    write.write("\nRedirecting to..." + getSetObj.getHost() + getSetObj.getPath() + "\n\n");
                }
    ...
    private static void redirect(GetSet getSetObj, String response) {
        System.out.println(response +
                "\nRedirecting to..."+redirectList.get(0)+"\n\n");
        getSetObj.setHost(redirectList.get(0));
        getSetObj.setPath("/");
